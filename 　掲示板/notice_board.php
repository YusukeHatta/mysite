        ...
        <div class="box-body">
          <form action="" method="post">
            <div class="form-group">
              ...
              <input type="text" name="name" value="" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your name">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">コメント</label>
              <input type="text" name="comment" value="" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Comment">
            </div>
            <input class="btn btn-primary" name="regist" type="submit" value="投稿">
          </form>
          <form action="main.php" method="post">
            <input class="btn btn-primary" type="submit" value="トップページ">
          </form>

          <?php
              $host = 'localhost';
              $dbname = 'comment_board';
              $dbuser = 'root';
              ...
              if( isset($_POST['regist']) ){
                  ...
                  $stmt = $pdo -> prepare("INSERT INTO comment_board (name, comment) VALUES (:name, :comment)");
